...
function una5ahaInfoPage() {
  ...
  <style>
    ...
    .u5-badges .u5-shop-badge { background:#e3b341; color:#1a1305; border:none; border-radius:999px; padding:7px 10px 7px 14px;
    ...
    .u5-door { display:inline-flex; align-items:center; justify-content:center; width:24px; height:24px;
               background:#1a1305; border:2px solid #ffffff; border-radius:6px; font-size:16px; line-height:1; }
    .u5-storerow { display:flex; gap:8px; }
    .u5-store-icon { display:flex; align-items:center; justify-content:center; width:44px; height:44px;
                      background:#0d1117d0; border:1px solid #ffffff2e; border-radius:10px; }
    .u5-store-icon svg { width:22px; height:22px; }
    .u5-store-icon.disabled { background:#ffffff; border-color:#ffffff; pointer-events:none; }
    ...
    .u5-si-body { color:#c9d1d9; font-size:14px; font-weight:400; opacity:.85; }
